...
'''
docker.py: an example of converting a docker to a singularity image using
singularity-python. This is now dated and not the recommended standard. The recommended way
is to use singularity natively, see:
